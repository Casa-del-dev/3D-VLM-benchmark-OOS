...
input_dir = Path("/work/courses/3dv/team1/data/HD-EPIC/Videos/P04_raw")
output_dir = Path("/work/courses/3dv/team1/data/HD-EPIC/Videos/P04_preprocessed_with_watermark")
